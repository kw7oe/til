defmodule Til.AccountsTest do
  ...
  describe "users" do
    ...
    @valid_attrs %{confirmation_token: "some confirmation_token", confirmed: true, name: "some name"}
    @update_attrs %{confirmation_token: "some updated confirmation_token", confirmed: false, name: "some updated name"}
    @invalid_attrs %{confirmation_token: nil, confirmed: nil, name: nil}
